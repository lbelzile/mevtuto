...
\includegraphics{mevtuto_files/figure-latex/profileandconfint-1.pdf}
...
\includegraphics{mevtuto_files/figure-latex/profileandconfint-2.pdf}
...
\includegraphics{mevtuto_files/figure-latex/tstabplots-1.pdf}
...
\includegraphics{mevtuto_files/figure-latex/tstabplots-2.pdf}
...
\includegraphics{mevtuto_files/figure-latex/Wdiag-1.pdf}
...
\includegraphics{mevtuto_files/figure-latex/NCdiag-1.pdf}
...
\tightlist
\item
  Try using the threshold diagnostic tests on the \texttt{nidd} river flow data. Which threshold would you choose based on the conclusions of the test? Repeat the analysis on your favorite dataset.
\item
...
\includegraphics{mevtuto_files/figure-latex/penult-1.pdf}
...
\includegraphics{mevtuto_files/figure-latex/penultimateshape-1.pdf}
...
\includegraphics{mevtuto_files/figure-latex/maxstabtest-1.pdf}
...
\includegraphics{mevtuto_files/figure-latex/extcoef-1.pdf}
...
\includegraphics{mevtuto_files/figure-latex/extcoef-2.pdf}
...
\NormalTok{ semivariomat <-}\StringTok{ }\KeywordTok{power.vario}\NormalTok{(}\KeywordTok{distg}\NormalTok{(coord, a, rho), }\DataTypeTok{alpha =}\NormalTok{ alpha, }\DataTypeTok{scale =}\NormalTok{ scale)}
